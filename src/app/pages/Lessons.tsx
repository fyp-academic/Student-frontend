                  ...
                  {currentRawType === 'file' && resourceUrl && (
                    <div className="bg-white rounded-xl overflow-hidden" style={{ boxShadow: "0 1px 4px rgba(0,0,0,0.06)" }}>
                      {resourceUrl.toLowerCase().endsWith('.pdf') ? (
                        <iframe src={resourceUrl} className="w-full rounded-xl" style={{ height: "calc(100vh - 260px)", minHeight: "400px" }} title={contentTitle} />
                      ) : (
                        <div className="flex flex-col items-center justify-center py-16 px-6 text-center">
                          ...
                          <p className="text-sm text-gray-500 mb-6">Download this file to view its contents.</p>
